local weaponMarkers = {
    ...
    "Kensington", "ZOZ-106", "Heardballa", "Whizz", "Rosen Nagan", "WISP", "WISP Pearl", "M-1020", "Dual SKORPS", "Micro KZI", "SilverSteel K1911", "KamatovDRUM", "RR-LightCompactPistol", "NGO", "RR-LCP", "KamatovS", "JS1-Competitor" },
    ...
    Juggernaut = {"VK's ANKM", "RY's GG-17", "AT's KAR15", "TG's JAVELIN-ZVD", "RVK", "Mason's K1911"},
}
